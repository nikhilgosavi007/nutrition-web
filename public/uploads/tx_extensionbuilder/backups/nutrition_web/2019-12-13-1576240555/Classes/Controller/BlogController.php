...
class BlogController extends \TYPO3\CMS\Extbase\Mvc\Controller\ActionController
{
     ...
     * @return void
     */
    public function showAction(\GroupProject\NutritionWeb\Domain\Model\Blog $blog)
    {
     ...
     * action create
     * 
     * @param \GroupProject\NutritionWeb\Domain\Model\Blog $newBlog
     * @return void
     */
    public function createAction(\GroupProject\NutritionWeb\Domain\Model\Blog $newBlog)
    {
     ...
     * @return void
     */
    public function editAction(\GroupProject\NutritionWeb\Domain\Model\Blog $blog)
    {
        $this->view->assign('blog', $blog);
    }
     ...
     * @return void
     */
    public function updateAction(\GroupProject\NutritionWeb\Domain\Model\Blog $blog)
    {
     ...
     * @return void
     */
    public function deleteAction(\GroupProject\NutritionWeb\Domain\Model\Blog $blog)
    {
